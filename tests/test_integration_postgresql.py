...
def memoryTable(liveDatabase):
    ...
    # equivalent; example_database_memory.py's docstring already flags "adjust
    # types to your database" for exactly this kind of difference
    liveDatabase.alter('CREATE TABLE {} (job VARCHAR(255) PRIMARY KEY, last_run DOUBLE PRECISION NOT NULL)'.format(tableName))
